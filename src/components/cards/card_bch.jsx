...
class CardBCH extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            error: null,
        ...
        if (error) {
            ...
            return (
                <div className="white-text text-center text-md-left col-md-4 mt-xl-5 mb-5">
                    <h2 className="h2-responsive font-weigth-bold">BCash</h2>
                    ...
                    <Row className="text-center">
                        ...
                        <Col md="4">
                            ...
                            <p>{new Intl.NumberFormat('pt-br', {
                                style: 'currency',
                                currency: 'BRL'
                            }).format(data.ticker.low)}
                            </p>
                        </Col>
                        <Col md="4">
                            <p>Negociadas</p>
                            <p>{new Intl.NumberFormat('pt-br').format(data.ticker.vol)}
                            </p>
                        </Col>
                    </Row>
                </div>
